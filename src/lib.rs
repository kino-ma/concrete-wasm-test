...
fn main() -> Result<(), JsError> {
    ...
    // // FIXME: This API is not supported (i.e., exported to WebAssembly) yet, but this sample does not work without this. The output bits will be like 0b1111..1111 without this function call.
